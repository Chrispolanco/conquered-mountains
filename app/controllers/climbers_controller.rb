class ClimbersController < ApplicationController
    ...
    private 
        ...
        def climber_params
            params.require(:climber).permit(:name, :age, :experience, :climber_members, climb_attributes: [:name, :duration, :date_started, :date_completed], mountains_attributes: [:name])
        end 
